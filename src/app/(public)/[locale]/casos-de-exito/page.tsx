    ...
    <div ref={containerRef} className="min-h-screen bg-white">
      ...
      <section className="relative pt-40 pb-32 overflow-hidden bg-[#00040a]">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
          <h1 className="hero-animate text-5xl md:text-7xl font-display font-semibold text-white mb-8 bg-gradient-to-r from-gobai-cyan to-gobai-turquoise bg-clip-text text-transparent uppercase">
            {t('hero.title')}
          </h1>
