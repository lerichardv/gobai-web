...
import { Search, Globe, Lock, Filter, X } from "lucide-react"
...
export function BlogFilters() {
  ...
  const updateFilters = useCallback((updates: Record<string, string | null>) => {
    ...
    router.push(`/admin/blog${query ? `?${query}` : ''}`)
  }, [router, searchParams])
  ...
  // Sync internal search state with URL (e.g. when back button is pressed)
  useEffect(() => {
