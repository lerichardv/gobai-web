	...
	return (
		...
		>
			...
			<div className="relative z-10 text-center lg:text-left px-6 mx-auto min-w-[300px] lg:pt-[25vh] lg:pl-[55vw] pb-36 md:pb-0">
				...
				<div className="hero-social mt-8 flex items-center justify-center lg:justify-start gap-4">
					<a 
						href="https://www.facebook.com/people/GOBAI/61578267635547/" 
						target="_blank" 
						rel="noopener noreferrer"
						className="w-12 h-12 rounded-full border border-white/10 bg-white/5 flex items-center justify-center text-white/50 hover:text-white hover:border-white/30 transition-all hover:scale-110"
					>
